...
export const Wallet = ({ wallet, isSolana, setWallets }: propTypes) => {
  ...
  return (
    <div className="flex justify-center md:mx-0 mx-2">
      <div className="md:w-[64%]  w-screen mt-10 ">
        {isWalletDeleteModalOpen ? (
          <div className="fixed inset-0 backdrop-blur-sm flex z-50 flex-col justify-center items-center text-white">
            <div className="flex flex-col border border-[#222] rounded-lg  bg-[#111] sm:w-[40%] md:w-[30%] w-[60%] ">
              ...
              <div className="flex justify-end mx-5 mb-6 my-4">
                <button
                  className="border border-gray-700 bg-[#000] rounded-md w-20 h-9 mx-2 text-lg hover:bg-gray-800 transform transition-transform duration-300 hover:scale-105"
                  onClick={() => {
                ...
                <button
                  className="border border-gray-700 bg-red-800 rounded-md w-20 h-9 mx-2 text-lg hover:bg-red-950 transform transition-transform duration-300 hover:scale-105"
                  onClick={() => {
                    setWallets((prevWallets) => {
                      const newWallets = prevWallets.filter(
                        (w) => w.id !== wallet.id
                      );
                      const storedWallets = localStorage.getItem("wallets");
                      const walletsArray = storedWallets
                        ? JSON.parse(storedWallets)
                        : [];
                      const walletsAfterDel = walletsArray.filter(
                        (w: any) => w.id !== wallet.id
                      );
                      localStorage.removeItem("wallets");
                      localStorage.setItem(
                        "wallets",
                        JSON.stringify(walletsAfterDel)
                      );
                      return newWallets;
                    });
                    setIsDeleteModalOpen(false);
        ...
        <div
          className={`p-5 border ${
            isOpen ? "border-t-0" : ""
          } border-gray-200 dark:border-gray-700 ${isOpen ? "" : "hidden"}`}
        ...
        >
          <div className="mb-2  border-b border-gray-500">
            ...
            <div className="flex justify-between">
              <p
                className=" mt-2 text-gray-500 hidden md:block hover:cursor-pointer"
              ...
              <p className=" mt-2 text-gray-500 block md:hidden">
          ...
          <div className="border-b border-gray-500 text-white mt-2">
            ...
            {isPrivKeyShown ? (
              <div className="flex justify-between mt-2">
                <p
                  className=" pb-2  text-gray-500 hidden 2xl:block"
                  title="click to copy the key"
                  onClick={() => {
                ...
                <p className=" pb-2  text-gray-500 md:block hidden 2xl:hidden">
                  {wallet.privateKey.substring(0, 42)}.....
                </p>
                <p className=" pb-2  text-gray-500 block md:hidden">
                  {wallet.privateKey.substring(0, 33)}.....
                </p>
                <EyeOffIcon
                  className="hover:cursor-pointer h-8 text-gray-200"
                  onClick={() => setisPrivKeyShown(!isPrivKeyShown)}
                />
              </div>
            ) : (
              <div
                className="flex justify-between flex-wrap hover:cursor-pointer"
                title="click to copy the key"
                onClick={() => {
                  navigator.clipboard.writeText(wallet.privateKey);
                }}
              >
                <p className="text-white md:text-xl pb-2 hidden xl:block">
                  .............................................................................................................
                </p>
                <p className="text-white md:text-xl pb-2 block xl:hidden">
                  ....................................................................
                </p>
                <EyeIcon
                  className="hover:cursor-pointer h-8 mt-2 text-gray-200"
                  onClick={() => setisPrivKeyShown(!isPrivKeyShown)}
                />
              </div>
            )}
