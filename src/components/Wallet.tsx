        ...
        <div className="md:w-[64%] md:ml-[294px] mt-10">
            ...
            >
                <div className="mb-2  border-b border-gray-500">
                    ...
                    <p className='text-white mt-2'>{wallet.publicKey}</p>
                ...
                <div className='border-b border-gray-500 text-white mt-2'>
                    ...
                    <div className='flex justify-between mt-2'>
                        <p className='text-white  pb-2'>{wallet.privateKey}</p>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <EyeIcon className='text-white hover:cursor-pointer h-8 mt-2' onClick={() => setisPrivKeyShown(!isPrivKeyShown)}/>
                    </div>}
                </div>
